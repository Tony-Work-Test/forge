...
export async function GetUsersWorklogs(userId: string): Promise<Worklog[]>{
  let entries: Worklog[] = [];
...
export async function restructureIssueData(
  issueId: string
): Promise<IFilteredData> {
